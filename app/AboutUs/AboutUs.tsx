...
export default function AboutUs() {
  return (
    <section className="bg-gray min-h-screen flex items-center">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <Card className="border-l-4 border-l-green">
            ...
            <CardContent>
              <p className="text-black">
                Nossa missão é proporcionar soluções de segurança inovadoras e confiáveis, protegendo nossos clientes
          ...
          <Card className="border-l-4 border-l-yellow">
            ...
            <CardContent>
              <p className="text-black">
                Aspiramos ser líderes globais em segurança digital, criando um mundo onde as pessoas e as organizações
                possam prosperar sem medo de ameaças cibernéticas.
              </p>
            </CardContent>
          </Card>
        </div>
